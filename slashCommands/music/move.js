...
module.exports = {
    ...
    run: async (client, interaction, args, prefix) => {
        ...
        return interaction.reply({ ephemeral: true, content: `🪣 **Successfully moved the \`${client.queuePos(args[0])} Song\` to \`${client.queuePos(args[1])} Position\` in the Queue.**`}).catch(() => null);
    },
};
